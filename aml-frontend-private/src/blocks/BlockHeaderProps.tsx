...
import { Form, Container, Row, Col, ButtonGroup, ToggleButton } from 'react-bootstrap';
...
export default function BlockHeaderProps({ currentBlock, errors }: BlockHeaderProps) {
